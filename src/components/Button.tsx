...
export const Button: FunctionComponent<ButtonProps> = ({ link, children, variant }) => {
    return (
        <a href={link} target="_blank" rel="noopener noreferrer" className="">
            <button className="w-auto px-10 sm:px-16 h-10 sm:h-12 relative  font-bold items-center justify-center group">
